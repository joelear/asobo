...
void main() async {
  ...
  await actions.setupErrorLogger();
  await actions.testCustomActionLogger();
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = asoboSupabaseUserStream()
      ..listen((user) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        unselectedItemColor: FlutterFlowTheme.of(context).foreground3,
